  ...
  return (
      <Layout seo={seo}>
          <div className="articlePages blogbox">
              ...
              <div className="article_showcase" style={{ background: `url('/assets/images/articles/3.png')` }}>
                  <div className="wrapper">
                      <PagePath prev="მთავარი" current="მაღაზიები" color="#fff" />
                  </div>
              </div>
              <div className="wrapper2 content">
                  <div className="title50">მაღაზიები</div>
                  <p>
